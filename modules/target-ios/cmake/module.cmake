if(PROJECT_TARGET_NAME STREQUAL "ios")
    ...
    file(GLOB H_FILES_LOGGER_PLATFORM "${PROJECT_MODULES_PATH}/logger/implementation/objc/nativium/util/*.h")
    file(GLOB S_FILES_LOGGER_PLATFORM "${PROJECT_MODULES_PATH}/logger/implementation/objc/nativium/util/*.m")

    file(GLOB H_FILES_FILE_HELPER_PLATFORM "${PROJECT_MODULES_PATH}/file-helper/implementation/objc/nativium/io/*.h")
    file(GLOB S_FILES_FILE_HELPER_PLATFORM "${PROJECT_MODULES_PATH}/file-helper/implementation/objc/nativium/io/*.m")

    file(GLOB H_FILES_HTTP_CLIENT_PLATFORM "${PROJECT_MODULES_PATH}/http-client/implementation/objc/nativium/net/http/*.h")
    file(GLOB S_FILES_HTTP_CLIENT_PLATFORM "${PROJECT_MODULES_PATH}/http-client/implementation/objc/nativium/net/http/*.m")

    file(GLOB H_FILES_SHARED_DATA_PLATFORM "${PROJECT_MODULES_PATH}/shared-data/implementation/objc/nativium/data/*.h")
    file(GLOB S_FILES_SHARED_DATA_PLATFORM "${PROJECT_MODULES_PATH}/shared-data/implementation/objc/nativium/data/*.m")

    if(PROJECT_USE_CXX_HTTP_CLIENT)
        file(GLOB H_FILES_HTTP_CLIENT_CXX "${PROJECT_MODULES_PATH}/http-client/implementation/cpp/nativium/net/http/Simple*.hpp")
        file(GLOB S_FILES_HTTP_CLIENT_CXX "${PROJECT_MODULES_PATH}/http-client/implementation/cpp/nativium/net/http/Simple*.cpp")
    endif()

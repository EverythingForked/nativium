...
CJNIEXPORT jobject JNICALL Java_com_nativium_util_Logger_00024CppProxy_shared(JNIEnv *jniEnv, jobject /*this*/)
{
    try
    {
...
CJNIEXPORT void JNICALL Java_com_nativium_util_Logger_00024CppProxy_v(JNIEnv *jniEnv, jobject /*this*/, jstring j_message)
{
    try
    {
        DJINNI_FUNCTION_PROLOGUE0(jniEnv);
...
CJNIEXPORT void JNICALL Java_com_nativium_util_Logger_00024CppProxy_d(JNIEnv *jniEnv, jobject /*this*/, jstring j_message)
{
    try
    {
        DJINNI_FUNCTION_PROLOGUE0(jniEnv);
...
CJNIEXPORT void JNICALL Java_com_nativium_util_Logger_00024CppProxy_i(JNIEnv *jniEnv, jobject /*this*/, jstring j_message)
{
    try
    {
        DJINNI_FUNCTION_PROLOGUE0(jniEnv);
...
CJNIEXPORT void JNICALL Java_com_nativium_util_Logger_00024CppProxy_w(JNIEnv *jniEnv, jobject /*this*/, jstring j_message)
{
    try
    {
        DJINNI_FUNCTION_PROLOGUE0(jniEnv);
...
CJNIEXPORT void JNICALL Java_com_nativium_util_Logger_00024CppProxy_e(JNIEnv *jniEnv, jobject /*this*/, jstring j_message)
{
    try
    {
        DJINNI_FUNCTION_PROLOGUE0(jniEnv);
...
CJNIEXPORT void JNICALL Java_com_nativium_util_Logger_00024CppProxy_setGroup(JNIEnv *jniEnv, jobject /*this*/, jstring j_group)
{
    try
    {
        DJINNI_FUNCTION_PROLOGUE0(jniEnv);

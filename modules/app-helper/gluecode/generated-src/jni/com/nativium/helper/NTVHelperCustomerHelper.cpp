...
CJNIEXPORT jboolean JNICALL Java_com_nativium_helper_CustomerHelper_00024CppProxy_isLogged(JNIEnv *jniEnv, jobject /*this*/)
{
    try
    {
...
CJNIEXPORT jstring JNICALL Java_com_nativium_helper_CustomerHelper_00024CppProxy_getToken(JNIEnv *jniEnv, jobject /*this*/)
{
    try
    {
        DJINNI_FUNCTION_PROLOGUE0(jniEnv);
...
CJNIEXPORT ::djinni_generated::NTVDomainCustomer::JniType JNICALL Java_com_nativium_helper_CustomerHelper_00024CppProxy_create(JNIEnv *jniEnv, jobject /*this*/)
{
    try
    {
        DJINNI_FUNCTION_PROLOGUE0(jniEnv);
...
CJNIEXPORT void JNICALL Java_com_nativium_helper_CustomerHelper_00024CppProxy_onCustomerLogin(JNIEnv *jniEnv, jobject /*this*/, ::djinni_generated::NTVDomainCustomer::JniType j_customer)
{
    try
    {
        DJINNI_FUNCTION_PROLOGUE0(jniEnv);

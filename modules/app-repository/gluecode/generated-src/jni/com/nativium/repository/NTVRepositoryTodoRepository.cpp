...
CJNIEXPORT void JNICALL Java_com_nativium_repository_TodoRepository_00024CppProxy_truncate(JNIEnv *jniEnv, jobject /*this*/)
{
    try
    {
...
CJNIEXPORT ::djinni_generated::NTVDomainTodo::JniType JNICALL Java_com_nativium_repository_TodoRepository_00024CppProxy_findById(JNIEnv *jniEnv, jobject /*this*/, jlong j_id)
{
    try
    {
        DJINNI_FUNCTION_PROLOGUE0(jniEnv);
...
CJNIEXPORT jobject JNICALL Java_com_nativium_repository_TodoRepository_00024CppProxy_findAllOrderByCreatedAtDesc(JNIEnv *jniEnv, jobject /*this*/)
{
    try
    {
        DJINNI_FUNCTION_PROLOGUE0(jniEnv);
...
CJNIEXPORT jobject JNICALL Java_com_nativium_repository_TodoRepository_00024CppProxy_findByTitle(JNIEnv *jniEnv, jobject /*this*/, jstring j_title)
{
    try
    {
        DJINNI_FUNCTION_PROLOGUE0(jniEnv);
...
CJNIEXPORT jboolean JNICALL Java_com_nativium_repository_TodoRepository_00024CppProxy_removeById(JNIEnv *jniEnv, jobject /*this*/, jlong j_id)
{
    try
    {
        DJINNI_FUNCTION_PROLOGUE0(jniEnv);
...
CJNIEXPORT jlong JNICALL Java_com_nativium_repository_TodoRepository_00024CppProxy_update(JNIEnv *jniEnv, jobject /*this*/, jlong j_id, ::djinni_generated::NTVDomainTodo::JniType j_todo)
{
    try
    {
        DJINNI_FUNCTION_PROLOGUE0(jniEnv);
...
CJNIEXPORT jlong JNICALL Java_com_nativium_repository_TodoRepository_00024CppProxy_insert(JNIEnv *jniEnv, jobject /*this*/, ::djinni_generated::NTVDomainTodo::JniType j_todo)
{
    try
    {
        DJINNI_FUNCTION_PROLOGUE0(jniEnv);
...
CJNIEXPORT jlong JNICALL Java_com_nativium_repository_TodoRepository_00024CppProxy_add(JNIEnv *jniEnv, jobject /*this*/, ::djinni_generated::NTVDomainTodo::JniType j_todo)
{
    try
    {
        DJINNI_FUNCTION_PROLOGUE0(jniEnv);
...
CJNIEXPORT jboolean JNICALL Java_com_nativium_repository_TodoRepository_00024CppProxy_setDoneById(JNIEnv *jniEnv, jobject /*this*/, jlong j_id, jboolean j_done)
{
    try
    {
        DJINNI_FUNCTION_PROLOGUE0(jniEnv);
...
CJNIEXPORT jlong JNICALL Java_com_nativium_repository_TodoRepository_00024CppProxy_count(JNIEnv *jniEnv, jobject /*this*/)
{
    try
    {
        DJINNI_FUNCTION_PROLOGUE0(jniEnv);

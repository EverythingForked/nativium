if(NATIVIUM_TARGET STREQUAL "windows")
    # module files
    file(GLOB H_FILES_C "${NATIVIUM_ROOT_PATH}/projects/others/nativium/include/*.h")
    file(GLOB H_FILES_CXX "${NATIVIUM_ROOT_PATH}/projects/others/nativium/include/*.hpp")

    file(GLOB S_FILES_CXX "${NATIVIUM_ROOT_PATH}/projects/others/nativium/src/*.cpp")
